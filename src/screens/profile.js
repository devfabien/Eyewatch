...
import { LogoutUser,EditUser,loginUser } from "../features/AuthenticationSlice";
        ...
        <SafeAreaView style={{backgroundColor:"transparent"}}>
            <View>
                <View style={{backgroundColor:"#27272a",padding:15,flexDirection:"row",justifyContent:"space-between"}}>
                    ...
                    <Octicons name="inbox" size={28} color="white" onPress={()=> Nav.navigate('inbox')}/>
                     </View>
...
<Text style={{color:"white",fontSize:20}}>Hi,  {usercredential.name} </Text>
<Text style={{color:"white",fontSize:8}}> {usercredential.email}</Text>
</View>
<TouchableOpacity onPress= {() => {navigation.navigate ("edit",usercredential)}}>
